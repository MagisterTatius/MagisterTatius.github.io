...
taboaContidos[0]=new act("1. Exercitium primum","1. Exercitium primum","","<object width='100%' height='420' type='text/html' data='01.03.01.Relacionar_Palabras/01.03.01.Relacionar_Palabras.htm'></object>",false,"",true,false,false);
taboaContidos[1]=new act("2. Exercitium secundum","2. Exercitium secundum","","<object width='100%' height='420' type='text/html' data='01.03.02.Completar_Texto.Selec/01.03.02.Completar_Texto.Selec.htm'></object>",false,"",true,false,false);
taboaContidos[2]=new act("3. Exercitium tertium","3. Exercitium tertium","","<object width='100%' height='420' type='text/html' data='01.03.03.Completar_Texto.Arras/01.03.03.Completar_Texto.Arras.htm'></object>",false,"",true,false,false);
taboaContidos[3]=new act("4. Exercitium quartum","4. Exercitium quartum","","<object width='100%' height='420' type='text/html' data='01.03.04.Completar_Texto.Escri/01.03.04.Completar_Texto.Escri.htm'></object>",false,"",true,false,false);
taboaContidos[4]=new act("5. Exercitium quintum","5. Exercitium quintum","","<object width='100%' height='420' type='text/html' data='01.03.05.Completar_Texto.Escri/01.03.05.Completar_Texto.Escri.htm'></object>",false,"",true,false,false);
taboaContidos[5]=new act("6. Exercitium sextum","6. Exercitium sextum","","<object width='100%' height='420' type='text/html' data='01.03.06.Ordenar_Frases/01.03.06.Ordenar_Frases.htm'></object>",false,"",true,false,false);
taboaContidos[6]=new act("7. Exercitium septimum","7. Exercitium septimum","","<object width='100%' height='420' type='text/html' data='01.03.07.Relacionar_Frase-Fras/01.03.07.Relacionar_Frase-Fras.htm'></object>",false,"",true,false,false);
taboaContidos[7]=new act("8. Exercitium octauum","8. Exercitium octauum","","<object width='100%' height='420' type='text/html' data='01.03.08.Seleccionar_palabra_c/01.03.08.Seleccionar_palabra_c.htm'></object>",false,"",true,false,false);
taboaContidos[8]=new act("9. Exercitium nonum","9. Exercitium nonum","","<object width='100%' height='420' type='text/html' data='01.03.09.Esquema.Completar_Cad/01.03.09.Esquema.Completar_Cad.htm'></object>",false,"",true,false,false);
taboaContidos[9]=new act("10. Exercitium decimum","10. Exercitium decimum","","<object width='100%' height='420' type='text/html' data='01.03.10.Esquema.Completar_Cad/01.03.10.Esquema.Completar_Cad.htm'></object>",false,"",true,false,false);
