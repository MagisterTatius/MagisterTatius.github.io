...
$(document).ready(function () {$("body").css({backgroundColor:"#FFFFFF"});var tabs = $("#Grammatica01ardoraTabs").tabs({heightStyle: "fill"});$("body").on("resize", function () {tabs.tabs("refresh");});
tabs.find( ".ui-tabs-nav" ).sortable({axis:"x",stop: function() {tabs.tabs("refresh");}});
 $( "#Grammatica01ardoraTabs" ).tabs({collapsible: true});
$( "#Grammatica01ardoraTabs" ).tabs({event: "mouseover"});
});
