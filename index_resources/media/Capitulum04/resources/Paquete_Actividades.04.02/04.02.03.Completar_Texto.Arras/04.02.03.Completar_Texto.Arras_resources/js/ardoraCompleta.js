...
containment: "document",revert: "invalid",cursor: "move",start: handleDragStart,drag: function (event, ui) {},stop: function () {}});}
...
ui.draggable.position({of: $(this),my: "left top",at: "left top"});ui.draggable.draggable("option", "revert", "invalid");ui.draggable.element = $(this);}
...
contexto.font="13px " + fMenssage; var indexHelp=parseInt($(item).attr("name").substring(4));var metricsW = contexto.measureText(itemHelp[indexHelp-1]).width+20;
var metricsH = 20+11+10;$("#ardoraHelpCanvas").attr({"width": metricsW,"height": metricsH});var topHelp=Math.round($(item).position().top)-metricsH;
...
contexto.font="13px " + fMenssage;contexto.shadowBlur = 0;contexto.shadowOffsetX = 0;contexto.shadowOffsetY = 0;
...
if (theItem.value!=""){var theAnswer=document.getElementById(theItem.value).innerHTML.replace("<p>","");theAnswer=theAnswer.replace("</p>","");
