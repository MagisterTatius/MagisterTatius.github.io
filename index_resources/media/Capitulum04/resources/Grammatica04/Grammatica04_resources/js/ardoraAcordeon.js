...
$(document).ready(function () {$("body").css({backgroundColor:"#FFFFFF"});var tabs = $("#Grammatica04ardoraTabs").tabs({heightStyle: "fill"});$("body").on("resize", function () {tabs.tabs("refresh");});
tabs.find( ".ui-tabs-nav" ).sortable({axis:"x",stop: function() {tabs.tabs("refresh");}});
 $( "#Grammatica04ardoraTabs" ).tabs({collapsible: true});
$( "#Grammatica04ardoraTabs" ).tabs({event: "mouseover"});
});
