...
$(document).ready(function () {$("body").css({backgroundColor:"#FFFFFF"});var tabs = $("#Grammatica02ardoraTabs").tabs({heightStyle: "fill"});$("body").on("resize", function () {tabs.tabs("refresh");});
tabs.find( ".ui-tabs-nav" ).sortable({axis:"x",stop: function() {tabs.tabs("refresh");}});
 $( "#Grammatica02ardoraTabs" ).tabs({collapsible: true});
$( "#Grammatica02ardoraTabs" ).tabs({event: "mouseover"});
});
