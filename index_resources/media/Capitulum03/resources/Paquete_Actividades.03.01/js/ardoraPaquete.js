...
taboaContidos[0]=new act("1. Exercitium primum","1. Exercitium primum","","<object width='100%' height='420' type='text/html' data='03.01.01.Seleccionar_pal_parag/03.01.01.Seleccionar_pal_parag.htm'></object>",false,"",true,false,false);
taboaContidos[1]=new act("2. Exercitium secundum","2. Exercitium secundum","","<object width='100%' height='420' type='text/html' data='03.01.02.Relacionar_Palabras/03.01.02.Relacionar_Palabras.htm'></object>",false,"",true,false,false);
taboaContidos[2]=new act("3. Exercitium tertium","3. Exercitium tertium","","<object width='100%' height='420' type='text/html' data='03.01.03.Completar_Texto.Selec/03.01.03.Completar_Texto.Selec.htm'></object>",false,"",true,false,false);
taboaContidos[3]=new act("4. Exercitium quartum","4. Exercitium quartum","","<object width='100%' height='420' type='text/html' data='03.01.04.Completar_Texto.Arras/03.01.04.Completar_Texto.Arras.htm'></object>",false,"",true,false,false);
taboaContidos[4]=new act("5. Exercitium quintum","5. Exercitium quintum","","<object width='100%' height='420' type='text/html' data='03.01.05.Completar_Texto.Escri/03.01.05.Completar_Texto.Escri.htm'></object>",false,"",true,false,false);
taboaContidos[5]=new act("6. Exercitium sextum","6. Exercitium sextum","","<object width='100%' height='420' type='text/html' data='03.01.06.Completar_Texto.Arras/03.01.06.Completar_Texto.Arras.htm'></object>",false,"",true,false,false);
taboaContidos[6]=new act("7. Exercitium septimum","7. Exercitium septimum","","<object width='100%' height='420' type='text/html' data='03.01.07.Seleccionar_palabra_c/03.01.07.Seleccionar_palabra_c.htm'></object>",false,"",true,false,false);
taboaContidos[7]=new act("8. Exercitium octauum","8. Exercitium octauum","","<object width='100%' height='420' type='text/html' data='03.01.08.Relacionar_Imaxe-Fras/03.01.08.Relacionar_Imaxe-Fras.htm'></object>",false,"",true,false,false);
taboaContidos[8]=new act("9. Exercitium nonum","9. Exercitium nonum","","<object width='100%' height='420' type='text/html' data='03.01.09.Seleccionar_pal_parag/03.01.09.Seleccionar_pal_parag.htm'></object>",false,"",false,false,false);
