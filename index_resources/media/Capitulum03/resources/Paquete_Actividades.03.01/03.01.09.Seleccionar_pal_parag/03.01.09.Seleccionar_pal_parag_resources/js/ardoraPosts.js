...
document.styleSheets[0].insertRule(".normalWord:hover{border-color: "+colorSele+"; }", 0);
document.styleSheets[0].insertRule(".normalWord{border-color: "+colorBack+"; }", 0);
document.styleSheets[0].insertRule(".normalWord{background-color: "+colorBack+"; }", 0);
}
